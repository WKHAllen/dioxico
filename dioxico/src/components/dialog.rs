...
use super::{Button, ButtonStyle, IconButton, IconButtonSize, Popover, PopoverType, XMARK_ICON};
use crate::classes;
...
pub fn Dialog(
    ...
    rsx! {
      Popover {
        ...
        anchored: false,
        backdrop: true,
        on_dismiss: move || on_close_request.call(false),
        class: classes!("dioxico-dialog", format!("dioxico-dialog-{}", size.css_repr()), class),
